...
class MainAction extends DashAction {
  ...
  public function performAction($dashboard){
    ...
    $query = 'INSERT INTO '.$cm->getPostsTableString().' (title, introduction, banner, content, date, category, poster, tags, classes, friendly_name, status) VALUES (:title, :introduction, :banner, :content, :date, :category, :poster, :tags, :classes, :friendly_name, :status)';
